...
const FOUNDERS = [
  ...
  { name: 'Partner Name', role: 'Co-Founder and Property Consultant' },
];
      ...
      <header className="sticky top-0 z-20 border-b border-stone-200/80 bg-stone-50/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="text-lg font-semibold tracking-tight">
            Signature <span className="text-amber-600">Estates</span>
          </Link>
        ...
        <div className="mx-auto grid max-w-5xl gap-12 sm:grid-cols-2 sm:items-center">
          <Reveal>
            ...
            <p className="text-lg leading-relaxed text-stone-700">
              ...
              decisions. By combining local market knowledge with a personal approach, we have
          ...
          <Reveal>
            <div className="rounded-2xl border border-stone-200 bg-stone-50 p-8">
              ...
              <p className="text-sm leading-relaxed text-stone-600">
                ...
                not what is easiest to sell. That is the difference between a transaction and a
                relationship.
              </p>
            </div>
          </Reveal>
